                    ...
                    return (
                      ...
                      <fieldset disabled={loading} aria-busy={loading}>
                        <UserPhoto
                          ...
                          src={!data.user.avatar ? "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmviVyxBmtIOeZu0m7ccw4D60gZ89zj25hFTqRQhBpdFbGIW0f" : this.state.avatar || data.user.avatar} />
                          <div>
                            <input
                              id="file"
                              type="file"
